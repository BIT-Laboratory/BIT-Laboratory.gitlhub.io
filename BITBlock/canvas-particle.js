var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		var canvas = {
			...
			config: {
				...
				color: canvasConfig.color || "182, 209, 218",
				stroke: canvasConfig.stroke || "255,245,255",
		...
		canvas.element.style = " top: 0; left: 0; z-index:9;";
	...
	function canvasSize(canvas){
		...
		canvas.height = 500 || window.innerWeight || document.documentElement.clientHeight || document.body.clientHeight;
	}
